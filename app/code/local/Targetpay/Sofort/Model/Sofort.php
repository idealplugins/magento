...
class Targetpay_Sofort_Model_Sofort extends Mage_Payment_Model_Method_Abstract
	{
	...
	public function getOrderPlaceRedirectUrl() {
		return Mage::getUrl('sofort/sofort/redirect', array('_secure' => true, 'country_id' => $_POST["payment"]["country_id"]));
		}
	...
	public function setupPayment($bankId = false) {
		...
		$targetPay->setReturnUrl ( Mage::getUrl('sofort/sofort/return', array('_secure' => true, 'order_id' => $orderId) ));
		$targetPay->setReportUrl ( Mage::getUrl('sofort/sofort/report', array('_secure' => true, 'order_id' => $orderId) ));
