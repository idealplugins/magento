...
/*
	...
	iDEALplugins.nl
    TargetPay plugin v2 for Magento 1.4+

    (C) Copyright Yellow Melon 2014

 	@file 		Paybyinvoice Controller
...
class Targetpay_Paybyinvoice_PaybyinvoiceController extends Mage_Core_Controller_Front_Action
	{
	...
	public function redirectAction() {
		...
		$paybyinvoiceModel = Mage::getSingleton('paybyinvoice/paybyinvoice');
		$paybyinvoiceUrl = $paybyinvoiceModel->setupPayment($this->getRequest()->get('country_id'));
		header('Location: ' . $paybyinvoiceUrl);
		exit();
		}
	...
	public function reportAction() {
		...
		$testMode = (bool) Mage::getStoreConfig('payment/paybyinvoice/testmode');
		if ($testMode) {
