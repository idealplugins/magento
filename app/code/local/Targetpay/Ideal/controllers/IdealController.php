...
class Targetpay_Ideal_IdealController extends Mage_Core_Controller_Front_Action
{
    ...
    public function reportAction()
    {
        ...
        $orderId = (int)$this->getRequest()->get('order_id');
        $txId = (string)$this->getRequest()->getPost('trxid', null);
        if(!isset($txId)) {
        ...
        $targetPay = new TargetPayCore ($this->_tp_method, Mage::getStoreConfig('payment/ideal/rtlo'),
            "f8ca4794a1792886bb88060ca0685c1e", $language, false);
