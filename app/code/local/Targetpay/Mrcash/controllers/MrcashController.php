...
class Targetpay_Mrcash_MrcashController extends Mage_Core_Controller_Front_Action
	{
	...
	public function redirectAction() {
		...
		$mrcashUrl = $mrcashModel->setupPayment();
		header('Location: ' . $mrcashUrl);
		exit();
		}
	...
	public function reportAction() {
		...
		$testMode = (bool) Mage::getStoreConfig('payment/mrcash/testmode');
		if ($testMode) {
